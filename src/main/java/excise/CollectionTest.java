...
public class CollectionTest
{
	...
	{
//		String[] aArray = {"aaa", "bbb", "ccc"};
//		String[] bArray = {"aaa", "bbb", "ccc", "ddd"};
//		Map<String, PlatformSignVo > platforsignMap = new HashMap<>();
//		platforsignMap.put("1", new PlatformSignVo("123456", "Rsa", Timestamp.valueOf("2016-02-16 00:00:00"), Timestamp.valueOf("2016-02-16 00:00:00"), "DEFAULT"));
//		platforsignMap.put("2", new PlatformSignVo("123457", "Rsa", Timestamp.valueOf("2016-02-17 00:00:00"), Timestamp.valueOf("2016-02-17 00:00:00"), "DEFAULT"));
//		Map<String, PlatformSignVo> oldMap = platforsignMap;
//		List aList = new ArrayList();   
//		List bList = new ArrayList();   
//		Set strSet = new HashSet();   
//		CollectionUtils.addAll(aList, aArray);  
//		CollectionUtils.addAll(bList, bArray); 
