...
public class ConvertMoneyToUppercase {  
    ...
    public static String convertMoney(double money) {  
        ...
        for (; numIndex < strMoney.length(); numIndex++, unitIndex++) {  
            ...
            if (num == '0') {  
                isZero = true;  
                if (Objects.equals(UNIT[unitIndex], "亿") || Objects.equals(UNIT[unitIndex], "万")
                        || Objects.equals(UNIT[unitIndex], "元")) { // 如果当前位是亿、万、元，且数值为零
    ...
    public static void main(String[] args) {  
        double value = Double.parseDouble("0.01");
