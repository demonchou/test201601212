...
public class Reflect
{
    ...
    public static void Demo3() throws ClassNotFoundException, InstantiationException, IllegalAccessException
    {
        ...
        Person2 person = (Person2) class1.newInstance();
        person.setAge(20);
    ...
    public static void Demo4() throws ClassNotFoundException, IllegalArgumentException, InstantiationException, IllegalAccessException, InvocationTargetException
    {
        ...
        person1 = (Person2) constructors[0].newInstance();
        person1.setAge(30);
        person1.setName("leeFeng");

        person2 = (Person2) constructors[1].newInstance(20, "leeFeng");
    ...
    {
        Class<?> class1 = null;
        class1 = Class.forName("excise.SuperMan");
...
class SuperMan extends Person2 implements ActionInterface
{
